    ...
    return (
        <div className="relative mb-6">
            {!isOpen ? (
                ...
                <div className="bg-white border rounded-lg shadow-lg p-4 animate-in fade-in slide-in-from-top-2 duration-200" role="menu" aria-label="Add resume section">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="font-bold text-gray-900">Choose Section</h3>
                        <button type="button" onClick={() => setIsOpen(false)} className="text-gray-400 hover:text-gray-600" aria-label="Close section menu">
                            <X className="w-5 h-5" />
                        </button>
                    </div>
